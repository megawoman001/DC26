...
curl -X POST -d '{"switch":"00:00:00:00:00:00:00:01", "name":"flow-mod-1", "cookie":"0", "table_id": 0, "priority":"32768", "idle_timeout": 60, "hard_timeout": 60, "match": "eth_type:arp", "actions": "output:1", "action": "output:2", "action": "output:3", "active":"true", "actions":"output=1"}' http://172.31.2.32:8080/wm/staticentrypusher/json
